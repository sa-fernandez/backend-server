...
| GET | http://127.0.0.1:8000/api/images/getPokemonImage/ |This endpoint has the purpose to return a pokemon image base on the id.|idPokedex ej. idPokedex=1|
| GET | http://127.0.0.1:8000/api/images/getPokemonShinyImage/ |This endpoint has the purpose to return a pokemon image base on the id.|idPokedex ej. idPokedex=1|
| GET | http://127.0.0.1:8000/api/images/getTypeImage/ |This endpoint has the purpose to return a type image base on the typeName|typeName ej. typeName=Fire|
